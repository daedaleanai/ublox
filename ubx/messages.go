...
const (
	...
	NavPVTDiffSoln      NavPVTFlags = 1 << 1 //    1 = differential corrections were applied
	NavPVTHeadVehValid  NavPVTFlags = 1 << 5 //     1 = heading of vehicle is valid, only set if the receiver is in sensor fusion mode
